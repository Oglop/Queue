...
const { roomSchema, queueSchema } = require('../../schemas').v1_0
/**
 * [] should have id
 */
...
module.exports = router.post('/:id/queues/', jsonSchemaRequestValidation(queueSchema), validateAccessToken, async (req, res, next) => {
    //await addRoomCommand(req.body)
    res.status(201).end()
});
